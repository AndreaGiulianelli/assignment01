    ...
    begin
        ...
        SimulationCicle:
            while currentIteration < simulation.iterations do
                OkPos:
                  await posBarrier = [w \in Workers |-> TRUE];
                  posBarrier := [w \in Workers |-> FALSE];
                AwaitComputation:
                    skip;
                ProcessLocal:
...
\* BEGIN TRANSLATION (chksum(pcal) = "53bcd75f" /\ chksum(tla) = "5e22417b")
...
\* Last modified Tue Apr 05 23:40:53 CEST 2022 by andrea
