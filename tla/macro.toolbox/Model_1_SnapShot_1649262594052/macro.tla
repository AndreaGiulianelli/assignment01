...
define
    ...
    SafetyInMasterResultProcess == (pc[Master] = "ProcessLocal" /\ ((\E w \in Workers: pc[w] = "NotifyMaster") \/ (\E w \in Workers: pc[w] = "CalculatePositions"))) = FALSE
end define
...
\* BEGIN TRANSLATION (chksum(pcal) = "61b8d8d" /\ chksum(tla) = "15c20564")
...
\* Last modified Wed Apr 06 18:29:48 CEST 2022 by andrea
