...
define
    ...
    \* Safety invariant
    SafetyInUpdate == []~((\E w \in Workers: pc[w] = "CalculateForceAndAcceleration") /\ (\E w \in Workers: pc[w] = "CalculatePositions"))
end define
...
\* BEGIN TRANSLATION (chksum(pcal) = "5b09ed97" /\ chksum(tla) = "6988bc52")
...
worker(self) == WaitToStart(self) \/ MainLoop(self)
                   ...
                   \/ BodyProcessForce(self) \/ CalculatePositions(self)
                   \/ BodyProcessPos(self) \/ NotifyMaster(self)
                   \/ AwaitPosConsistency(self)
...
\* Last modified Wed Apr 06 15:59:04 CEST 2022 by andrea
