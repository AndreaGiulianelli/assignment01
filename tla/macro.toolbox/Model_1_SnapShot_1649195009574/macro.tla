...
\* BEGIN TRANSLATION (chksum(pcal) = "9dec992a" /\ chksum(tla) = "f85c77a7")
...
MainLoop(self) == /\ pc[self] = "MainLoop"
                  /\ IF simulation.completed = FALSE
                        THEN /\ posBarrier' = [posBarrier EXCEPT ![self] = TRUE]
...
\* Last modified Tue Apr 05 23:43:26 CEST 2022 by andrea
