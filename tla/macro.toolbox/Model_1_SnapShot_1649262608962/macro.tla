...
define
    ...
    SafetyInMasterResultProcess == (pc[Master] = "ProcessLocal" /\ ((\E w \in Workers: pc[w] = "AwaitPosConsistency") \/ (\E w \in Workers: pc[w] = "CalculatePositions"))) = FALSE
end define
...
\* BEGIN TRANSLATION (chksum(pcal) = "7a023319" /\ chksum(tla) = "a3b1c3d6")
...
\* Last modified Wed Apr 06 18:30:05 CEST 2022 by andrea
