...
\* BEGIN TRANSLATION (chksum(pcal) = "7b02cd0c" /\ chksum(tla) = "fec899a0")
...
OkPos == /\ pc[Master] = "OkPos"
         ...
         /\ UNCHANGED << simulation, iterationsDone, bodies, jobs, nWorkers, 
                         bodiesComputed, completedLatch, okPosBarrier, 
...
\* Last modified Tue Apr 05 23:38:11 CEST 2022 by andrea
